 ...
 * Slug: gallopwp/footer-default-dark
 * Categories: footer
...
<p>&copy; <?php echo esc_html( gmdate( 'Y' ) ); ?> <?php echo esc_html__( 'Your Company LLC', 'gallopwp' ); ?> · <a href="#"><?php echo esc_html__( 'Contact Us', 'gallopwp' ); ?></a></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><a href="#"><?php echo esc_html__( 'Facebook', 'gallopwp' ); ?></a> · <a href="#"><?php echo esc_html__( 'Twitter', 'gallopwp' ); ?></a> · <a href="#"><?php echo esc_html__( 'Instagram', 'gallopwp' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
