 ...
 * Slug: gallopwp/footer-stacked-dark
 * Categories: footer
...
<h2 class="wp-block-heading has-text-align-center has-max-48-font-size" id="let-s-connect" style="margin-bottom:20px"><?php echo esc_html__( 'Let’s Connect', 'gallopwp' ); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="#"><?php echo esc_html__( 'Get in Touch', 'gallopwp' ); ?> →</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
<!-- wp:paragraph {"align":"center","fontSize":"small"} -->
<p class="has-text-align-center has-small-font-size">&copy; <?php echo esc_html( gmdate( 'Y' ) ); ?> <?php echo esc_html__( 'Your Company LLC', 'gallopwp' ); ?> · <a href="#"><?php echo esc_html__( 'Contact Us', 'gallopwp' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
